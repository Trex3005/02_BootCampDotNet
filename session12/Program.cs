...
internal class Program
{
    private static void Main(string[] args)
    {
        ...
        // // tính đóng gói trong OOP (Encapsultation)
        ...
        // // để truy cập vào các thuộc tính đó, ta sử dụng các phương thức:
        // // getter và setter

        // // tạo đối tượng person
        // // dùng try ...catch để bắt lỗi nếu lỗi có xảy ra
        // try
        // {
        //     Person person = new Person("NVA", 10);
        //     // person.name = Nguyễn Văn A
        //     person.Name = "Nguyen Van An"; // đi qua setter của Name
